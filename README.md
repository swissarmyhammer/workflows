...
Shared GitHub Actions workflows and actions for the swissarmyhammer
repositories.

| File | Type | Use |
| --- | --- | --- |
| `.github/workflows/swift-ci.yaml` | Reusable workflow | Build and test a Swift package. |
| `.github/workflows/ci.yaml` | Reusable workflow | Build, test and lint a Rust crate. |
| `.github/actions/swift-test` | Composite action | Run `swift test`, and fail a run that measured nothing. |
